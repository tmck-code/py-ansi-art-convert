...
CP437_BOX_MAP = (
    # └     ┘     ├     ┬     ┐     ┤
    0xC0, 0xD9, 0xC3, 0xC2, 0xC1, 0xB4,
)
CP437_DOUBLE_BOX_MAP = (
    # ╢     ╖     ╕     ╣     ║     ╗      ╝     ╜     ╛     ╞     ╟     ╚     ╔ 
    0xB6, 0xB7, 0xB8, 0xB9, 0xBA, 0xBB, 0xBC, 0xBD, 0xBE, 0xC6, 0xC7, 0xC8, 0xC9,
    #  ╩    ╦      ╠     ═     ╬     ╧     ╨     ╤     ╥     ╙     ╓     ╫     ╪
    0xCA, 0xCB, 0xCC, 0xCD, 0xCE, 0xCF, 0xD0, 0xD1, 0xD2, 0xD3, 0xD6, 0xD7, 0xD8,
)
ISO_8859_1_BOX_MAP = (
    # |     \     /     ¯     _
    0x7c, 0x5c, 0x2f, 0xaf, 0x5f,
)
POPULAR_CHAR_MAP = {
